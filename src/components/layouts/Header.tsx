...
const Header = () => {
	...
	return (
		<section className="header">
			...
			<svg className='header__arrow' width="71" height="77" viewBox="0 0 71 77" fill="none"><g opacity="0.8"><path opacity="0.8" d="M70 1L40.5153 18.0926C37.4135 19.8907 33.5865 19.8907 30.4847 18.0926L1 1" stroke="#9945FF" stroke-linecap="round" stroke-linejoin="round"></path><path opacity="0.6" d="M70 29L40.5153 46.0926C37.4135 47.8907 33.5865 47.8907 30.4847 46.0926L1 29" stroke="#9945FF" stroke-linecap="round" stroke-linejoin="round"></path><path opacity="0.4" d="M70 57L40.5153 74.0926C37.4135 75.8907 33.5865 75.8907 30.4847 74.0926L1 57" stroke="#9945FF" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
		</section>
	);
};
